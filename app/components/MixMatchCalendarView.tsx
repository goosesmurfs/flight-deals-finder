                ...
                return (
                  <div key={index} className={`bg-white rounded-lg border p-5 hover:shadow-md transition-shadow duration-200 ${
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        {deal.isMixedAirlines && (
                          <span className="inline-block bg-emerald-600 text-slate-900 text-xs px-2 py-1 rounded-full mt-1">
                    ...
                    <div className="mb-3 pb-3 border-b border-slate-200">
                      <div className="text-xs font-semibold text-slate-600 mb-1">OUTBOUND</div>
                    ...
                    {/* Return Flight */}
                    <div className="mb-3">
                      <div className="text-xs font-semibold text-slate-600 mb-1">RETURN</div>
                      <div className="flex justify-between items-center">
        ...
        return (
          <div key={`${year}-${month}`} className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                    ...
                    {cheapestDeal && (
                      <div className="text-xs space-y-1">
                        ...
                        {cheapestDeal.isMixedAirlines && (
                          <div className="inline-block bg-emerald-600 text-slate-900 text-xs px-1 rounded">
                            Mixed
                          </div>
                        )}
                        {dealsCount > 1 && (
            ...
            <div className="mt-4 flex flex-wrap gap-4 text-xs">
              ...
              <div className="flex items-center gap-2">
                <div className="inline-block bg-emerald-600 text-slate-900 text-xs px-2 py-0.5 rounded font-semibold">
                  Mixed
                </div>
